...
- **Output settings**: Advanced (above Convert) chooses 1280×720 or 1920×1080, mute or which occupied cell supplies audio, letterbox or crop, duration, and pad
- **Duration**: Full length (pad shorter clips to the longest with black or a freeze frame) or cap output at 5, 15, 30, or 60 seconds from the start
...
3. **Output settings**: Click Advanced (just above Convert) to set resolution, duration, pad, audio, and letterbox vs crop
4. **Rearrange**: Drag a filled cell onto another to swap clips, or onto an empty cell to copy (the source stays filled)
